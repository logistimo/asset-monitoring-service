...
public abstract class ZooElectableClient implements Watcher, ZkDataMonitor.ZkNodeDataListener {
  ...
  protected ZooElectableClient() throws KeeperException, IOException, InterruptedException {
    ...
    this.timeout =
        Integer.parseInt(Play.application().configuration().getString("zoo.timeout", "3000"));
  ...
  private void createElectionGUIDZNode() throws KeeperException, InterruptedException {
    ...
    LOGGER.info(
        "ZooElectableClient::createElectionGUIDZNode:: created with path:" + electionGUIDZNodePath);
  }
