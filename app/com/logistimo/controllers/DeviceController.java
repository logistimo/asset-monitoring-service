...
public class DeviceController extends BaseController {
    ...
    @Transactional(readOnly = true)
    @With(SecuredAction.class)
    public static Result getDeviceRecentAlerts(String vendorId, String deviceId, String sid, int page, int size, String callback) {
        try {
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getDeviceRecentAlarms(vendorId, deviceId, sid, page, size)));
        } catch (NoResultException e) {
            LOGGER.warn(Messages.get("device.not_found"), e);
            return prepareResult(NOT_FOUND, callback, e.getMessage());
        } catch (Exception e) {
    ...
    public static Result createOrUpdateDevice(String callback) {
        ...
        try {
            deviceRegisterRequest = getValidatedObject(request().body().asJson(), DeviceRegisterRequest.class);
        } catch (Exception e) {
        ...
        try {
            DeviceCreationResponse deviceCreationResponse = deviceService.createOrUpdateDevice(deviceRegisterRequest);
    ...
    public static Result deleteDevice(String callback) {
        ...
        try {
            deviceDeleteRequest = getValidatedObject(request().body().asJson(), DeviceDeleteRequest.class);
        } catch (Exception e) {
    ...
    public static Result createTag(String callback) {
        ...
        try {
            ...
            return prepareResult(CREATED, callback, tagRegisterRequest.data.size() + " devices received, " + numberOfDeviceUpdated + " tagged");
        } catch (Exception e) {
    ...
    @Transactional(readOnly = true)
    @With(SecuredAction.class)
    public static Result getDevicesStatusByTagName(String tagName, String q, String assetType, Integer workingStatus, Integer alarmType, Integer alarmDuration, Integer awr,
                                                   int pageNumber, int pageSize, String callback) {
        try {
            tagName = decodeParameter(tagName);
            return prepareResult(OK, callback, Json.toJson(deviceService.getDevicesByTag(tagName, q, assetType, workingStatus, alarmType, alarmDuration,awr, pageNumber, pageSize)));
        } catch (NoResultException e) {
    ...
    @Transactional(readOnly = true)
    @With(SecuredAction.class)
    public static Result getAbnormalDevicesByTagName(String tagName, int pageNumber, int pageSize, String callback) {
        try {
            tagName = decodeParameter(tagName);
            return prepareResult(OK, callback, Json.toJson(deviceService.getAbnormalDevicesByTags(tagName, pageNumber, pageSize)));
        } catch (NoResultException e) {
            LOGGER.warn("Device not found.", e);
            return prepareResult(NOT_FOUND, callback, "Device not found - " + e.getMessage());
        } catch (Exception e) {
    ...
    @Transactional(readOnly = true)
    @With(SecuredAction.class)
    public static Result getAbnormalDeviceCountByTagName(String tagPattern, String sType, String callback) {
        try {
            if( sType != null && sType.trim().equals("1") )
                return prepareResult(OK, callback, Json.toJson(deviceService.searchDeviceStatusByTagPattern(tagPattern)));
            else
                return prepareResult(OK, callback, Json.toJson(deviceService.getTaggedDeviceCountResponse(tagPattern)));
        } catch (NoResultException e) {
            LOGGER.warn("Device not found.", e);
            return prepareResult(NOT_FOUND, callback, "Device not found - " + e.getMessage());
        } catch (Exception e) {
    ...
    public static Result getChildTagSummary(String tagName, String callback) {
        try {
            tagName = decodeParameter(tagName);
            return prepareResult(OK, callback, Json.toJson(deviceService.searchDeviceStatusByParentTag(tagName)));
        } catch (NoResultException e) {
            LOGGER.warn("Device not found.", e);
            return prepareResult(NOT_FOUND, callback, "Device not found - " + e.getMessage());
        } catch (Exception e) {
    ...
    public static Result createDeviceConfig(String callback) {
        try {
            ...
            try {
                deviceConfigurationRequest = getValidatedObject(request().body().asJson(), DeviceConfigurationRequest.class);
            } catch (Exception e) {
    ...
    public static Result getDeviceConfig(String vendorId, String deviceId, String callback) {
        try {
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getDeviceConfiguration(vendorId, deviceId, true)));
        } catch (NoResultException e) {
    ...
    public static Result getDeviceConfigForApps(String vendorId, String deviceId, String callback) {
        try {
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getDeviceConfiguration(vendorId, deviceId, false)));
        } catch (NoResultException e) {
            LOGGER.warn("Error while reading device configuration", e);
            return prepareResult(NOT_FOUND, callback, e.getMessage());
        } catch (Exception e) {
    ...
    public static Result getDeviceConfigByTag(String vendorId, String tagName, String callback) {
        try {
            return prepareResult(OK, callback, Json.toJson(deviceService.getDeviceConfigurationByTagName(tagName)));
        } catch (NoResultException e) {
    ...
    public static Result createOrUpdateDeviceStatus(String callback) {
        ...
        try {
            deviceReadyUpdateRequest = getValidatedObject(request().body().asJson(), DeviceReadyUpdateRequest.class);
        } catch (Exception e) {
        ...
        try {
            DeviceReadyUpdateResponse deviceReadyUpdateResponse = deviceService.createOrUpdateDeviceReady(deviceReadyUpdateRequest);

            if (deviceReadyUpdateResponse.errs.size() > 0) {
                LOGGER.warn("Device Ready update - partial content: " + Json.toJson(deviceReadyUpdateResponse));
    ...
    public static Result pushConfigToDevice(String callback) {
        ...
        try {
            configurationPushRequest = getValidatedObject(request().body().asJson(), ConfigurationPushRequest.class);
        } catch (Exception e) {
    ...
    public static Result updateConfigPushStatus(String callback) {
        ...
        try {
            deviceSMSStatusRequest = getValidatedObject(request().body().asJson(), DeviceSMSStatusRequest.class);
        } catch (Exception e) {
    ...
    public static Result getAPNSettings(String vendorId, String deviceId ,String callback) {
        try{
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getAPNSettings(vendorId, deviceId)));
        }catch (NoResultException e){
            return prepareResult(NOT_FOUND, callback, e.getMessage());
        }catch(Exception e){
    ...
    public static Result getAdminSettings(String vendorId, String deviceId ,String callback) {
        try{
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getAdminSettings(vendorId, deviceId)));
        }catch (NoResultException e){
            return prepareResult(NOT_FOUND, callback, e.getMessage());
        }catch(Exception e){
    ...
    public static Result createAssetMapping(String callback){
        ...
        try{
            assetRegistrationRelationModel = getValidatedObject(request().body().asJson(), AssetRegistrationRelationModel.class);
        } catch (LogistimoException e) {
            LOGGER.warn("{} while parsing asset mapping json: {}", e.getMessage(), request().body().asJson().toString(), e);
    ...
    public static Result getAssetRelation(String vendorId, String deviceId, String callback){
        try{
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getAssetRelation(vendorId, deviceId)));
        }catch (NoResultException e){
            LOGGER.warn("Error while getting asset relation for the asset: {}, {}", vendorId, deviceId, e);
            return  prepareResult(NOT_FOUND, callback, e.getMessage());
        }catch(Exception e){
            LOGGER.error("Error while getting asset relation for the asset: {}, {}", vendorId, deviceId, e);
            return prepareResult(INTERNAL_SERVER_ERROR, callback, e.getMessage());
        }
    }
    ...
    @Transactional(readOnly = true)
    @With(SecuredAction.class)
    public static Result getDevicePowerTransition(String vendorId, String deviceId, Integer from, Integer to, String callback){
        try{
            deviceId = decodeParameter(deviceId);
            return prepareResult(OK, callback, Json.toJson(deviceService.getDevicePowerTransition(vendorId, deviceId, from, to)));
        }catch (NoResultException e){
            LOGGER.warn("Error while getting asset power transition for the asset: {}, {}", vendorId, deviceId, e);
            return  prepareResult(NOT_FOUND, callback, e.getMessage());
        }catch(Exception e){
            LOGGER.error("Error while getting asset power transition for the asset: {}, {}", vendorId, deviceId, e);
            return prepareResult(INTERNAL_SERVER_ERROR, callback, e.getMessage());
        }
    }
}
