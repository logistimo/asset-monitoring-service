...
public class StatsController extends BaseController {
  ...
  public static Result createStats(String callback) {
    ...
    try {
      StatsLoggingResponse
          statsLoggingResponse =
          statsService.postDailyStats(dailyStatsLoggingRequest);
  ...
  public static Result getStats(String vendorId, String deviceId, String sid, int pageNumber,
  ...
  @Transactional(readOnly = true)
  @With(SecuredAction.class)
  public static Result getStatsByRange(String vendorId, String deviceId, String sid, int from,
                                       int to, int pageNumber, int pageSize, String callback) {
    try {
      deviceId = decodeParameter(deviceId);
