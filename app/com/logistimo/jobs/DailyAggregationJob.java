...
public class DailyAggregationJob implements Job {
    ...
    private final String SQL = "select ex.device_id, abs(COALESCE((durationex - durationinc), (durationex-?1))) as duration" +
            " FROM (" +
    ...
    private void doJob() {
        ...
        if (result != null && result.size() > 0) {
            for (Object[] o : result) {
                ...
                try {
                    DailyAggregation agg = DailyAggregation.findbyYearAndMonthAndDayAndDevice(year, month, day, d);
